...
import { Briefcase, Calendar, Users, DollarSign, ArrowLeft, Check, Info, Image, Upload } from "lucide-react"
import Link from "next/link"
import { getProgramById, updateProgram } from "@/services/program-service"
...
export default function EditProgramPage({ params }: { params: { id: string } }) {
    ...
    const fetchProgram = async () => {
      try {
        ...
        setFormValues({
          ...
          volunteerNeeded: program.volunteers > 0,
          volunteers: program.volunteers?.toString() || "",
  ...
  const validateForm = () => {
    ...
    if (uploadOption === 'url' && formValues.imageUrl && !formValues.imageUrl.match(/^(http|https):\/\/[^ "]+$/)) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateProgram(params.id, programData)
      ...
      <div className="mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-1">Update program details and settings</p>
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              {uploadOption === 'url' ? (
                <>
                  ...
                  <p className="mt-1 text-xs text-gray-500">Enter a URL for an image that represents this program</p>
                  ...
                  {formValues.imageUrl && (
                    <div className="mt-4">
                      ...
                      <img 
                        ...
                        alt="Program preview" 
                        className="max-w-xs h-48 object-cover border border-gray-200 rounded-md" 
                        onError={(e) => {
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-amber-700">
                <p>
                  Updating a program will not affect donations that have already been made.
                </p>
              </div>
            </div>
          </div>
